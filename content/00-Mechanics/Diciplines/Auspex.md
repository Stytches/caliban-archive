...
This power does not let characters see in pitch darkness, as does Eyes of the Beast, but it does reduce difficulty penalties to act in such darkness from +2 to +1, and the character may make ranged attacks in pitch darkness if she can hear, smell, or otherwise detect her foe.
...
| Successes | Information Gleaned |
| :--- | :--- |
| **1 success** | Very basic info (gender, rough age of holder). |
| **2 successes** | Moderate info (emotional state, rough time of use). |
| **3 successes** | Clear info (identity, specific time, strong emotion). |
| **4 successes** | Detailed info (name, exact time, specific thoughts). |
| **5 successes** | Complete sensory playback of the event. |
